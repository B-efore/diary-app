...
public class SimpleCalendar extends AppCompatActivity implements Button.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case 체크리스트 삭제 버튼 :
                ...
                mDatabase.child("users").child(firebaseUser.getUid()).child("todo").child().setValue(null);
                break ;
            case 일정 수정 버튼 :
